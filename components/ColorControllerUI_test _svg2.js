...
const ColorControllerUI = ({ row, col, width, height, hSpace, vSpace, bgColor = 'rgb(255,255,255)' , initShapeColors }) => {
   ...
   //const backgroundColor = 'rgb(255,255,255)'; // Initial background color
    ...
    //const [shapeColors, setShapeColors] = useState(Array(shapeNum).fill(initColor)); // Array to store colors of each shape
  ...
  Array.from({ length: shapeNum }, (_, i) => initShapeColors ? initShapeColors[i % initShapeColors.length] : initColor)
    ...
    const handleShapeClick = (index) => {
        ...
        if (clonedOutputColor !== null && selectedShape !== 'background') {
            ...
            // COMBINED LOGIC FOR SELECTING MULTIPLE SHAPES
            ...
            if (shapeColors[index] === 'rgb(0,0,0)') {
                ...
                setYellow(255);
                setBlack(255);
            } else if (shapeColors[index]) {
                // Extract the RGB values from the color string and update the sliders
                const rgbValues = shapeColors[index].match(/\d+/g);
    ...
    const createGrid = (row, col, width, height, hSpace, vSpace) => {
        let gridArray = [];
        // Loop to create grid shapes
<svg width="790" height="863" viewBox="0 0 790 863" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_23_294)">
<rect width="235.89" height="1288.44" transform="matrix(0.735852 0.677143 -0.735852 0.677143 427.099 -397.649)" fill="#494949"/>
<rect width="235.89" height="1288.44" transform="matrix(0.735852 0.677143 -0.735852 0.677143 600.679 -237.918)" fill="#585858"/>
<rect width="235.89" height="1288.44" transform="matrix(0.735852 0.677143 -0.735852 0.677143 774.26 -78.1865)" fill="#626262"/>
<rect width="235.89" height="1288.44" transform="matrix(0.735852 0.677143 -0.735852 0.677143 947.839 81.5444)" fill="#707070"/>
<rect width="235.89" height="1288.44" transform="matrix(0.735852 0.677143 -0.735852 0.677143 1121.42 241.276)" fill="#787878"/>
</g>
<defs>
<clipPath id="clip0_23_294">
<rect width="790" height="863" fill="white"/>
</clipPath>
</defs>
</svg>
        return gridArray;
        ...
        shapeNum === 1
            ...
            : shapeNum === 2
                ...
                : shapeNum > 2 && shapeNum <= 3
                    ...
                    : shapeNum === 4
                        ? "grid-cols-2"
                        : shapeNum >= 5 && shapeNum <= 9
                            ? "grid-cols-3"
                            : shapeNum >= 10 && shapeNum <= 12
                                ? "grid-cols-4"
                                : "grid-cols-5";
    ...
    return (
        <div
         ...
         <div className="flex flex-col justify-center bg-[#898989] pt-10 rounded-2xl absolute scale-75 bottom-5 right-0 lg:scale-90 lg:bottom-9" style={{ position: 'fixed', zIndex: 1 }} slider-panel >
